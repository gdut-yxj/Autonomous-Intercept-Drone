...
sys.path.append(r"D:\Unreal\Unreal Projects\RL\scripts")
...
class EvaluateThread(QtCore.QThread):
    ...
    def run_drl_model(self):
        ...
        eval_folder = self.eval_path + '/eval_{}_{}'.format(self.eval_ep_num, self.eval_env)
...
def main():
    eval_path = r'D:\Unreal\Unreal Projects\RL\logs_new\Forest\2025_03_08_00_40__SimpleMultirotor_mlp_TD3\models'
    config_file = eval_path + '/config/config.ini'
    model_file = eval_path + '/model/model_sb3.zip'
...
def run_eval_multi():
    ...
    eval_ep_num = 50
    eval_env_name = 'Forest'
    eval_dynamic_name = 'SimpleNultirotor'
    model_list = []
